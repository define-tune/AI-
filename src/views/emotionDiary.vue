            ...
            <!-- 情绪评分 -->
             <div class="diary-card">
                ...
                <div class="section">
                    ...
                    <div class="rate">
                        <CustomRate v-model:score="diaryFrom.moodScore" :disbaled="false" 
                        :texts="emotionStatus" :show-text="true"
                        :size="`large`"
                        />
                    </div>
                </div>
             ...
             <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div class="emotion-card" v-for="image in emotionOptions" :key="image.name" @click="selectEmotion(image.name)" :class="{selected: image.name === diaryFrom.dominantEmotion}"">
                        <el-image :src="image.url" style="width: 50px; height: 50px;"></el-image>
                        <div class="emotion-name">{{ image.name }}</div>
             ...
             <div class="diary-card">
                ...
                <div class="detail-form">
                    <div class="form-group">
                        ...
                        <el-input v-model="diaryFrom.emotionTriggers" placeholder="今天什么事情影响了您的情绪" type="textarea"  :rows="3" maxlength="1000" show-word-limit resize="none"></el-input>
                        <div class="form-label">今日感想</div>
                        <el-input v-model="diaryFrom.diaryContent" placeholder="写下您今天的想法，感受或发生的有趣事情..." type="textarea"  :rows="5" maxlength="2000" show-word-limit resize="none"></el-input>
                    </div>
                    <!-- 生活指标 -->
...
const submit = () => {
    console.log(diaryFrom.value);
    if (!diaryFrom.moodScore) {
        ElMessage.error('请选择情绪评分')
        return
    }
    addEmotionDiaryAPI(diaryFrom).then(() => {
